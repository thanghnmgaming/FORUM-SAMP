...
class Setup extends AbstractSetup
{
	...
	protected $serializedFields = [
		'XFRM:Category' => ['field_cache', 'prefix_cache'],
		'XFRM:ResourceItem' => ['custom_fields', 'tags'],
		'XFRM:ResourceUpdate' => ['like_users'],
	];
	...
	public function upgrade2010010Step1(array $stepParams)
	{
		...
		return $this->entityColumnsToJson(
			'XFRM:Category', ['field_cache', 'prefix_cache', 'breadcrumb_data'], $position, $stepParams
		);
	}
	...
	public function upgrade2010010Step2(array $stepParams)
	{
		...
		return $this->entityColumnsToJson('XFRM:ResourceItem', ['custom_fields', 'tags'], $position, $stepParams);
	}
	...
	public function upgrade2010010Step3(array $stepParams)
	{
		...
		return $this->entityColumnsToJson('XFRM:ResourceUpdate', ['like_users'], $position, $stepParams);
	}
