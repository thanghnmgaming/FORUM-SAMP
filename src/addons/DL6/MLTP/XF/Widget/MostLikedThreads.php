...
class MostLikedThreads extends AbstractWidget
{
	...
	public function render()
	{
		...
		$threadFinder
		    ...
		    switch ($timeLapse)
		    {
			    default:
			    case 'today':
			        $title = \XF::phrase('ml_most_liked_threads_today');
			    ...
			    case 'week':
			        $title = \XF::phrase('ml_most_liked_threads_week');
					$week = date('w');
			    ...
			    case 'year':
			        $title = \XF::phrase('ml_most_liked_threads_year', ['year' => date('Y')]);
			    ...
			    case 'alltime':
					$title = \XF::phrase('ml_most_liked_threads_all_time');
				break;
				...
				case 'custom':
					...
					$title = \XF::phrase('ml_most_liked_threads_last_x_days', ['days' => $custom_time_frame_days]);
				break;
		    }
		...
		return $this->renderer('widget_dl6_most_liked_threads', $viewParams);
	}
