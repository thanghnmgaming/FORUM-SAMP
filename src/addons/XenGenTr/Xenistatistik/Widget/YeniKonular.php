...
class YeniKonular extends AbstractWidget
{
	...
	public function render()
	{
        ...
        $isAddonEnabledGlobally = \XF::options()->offsetGet('xenistatistik_yenikonukapat');
		...
		/*** gosterim limiti ***/
        $limit = \XF::options()->xenistatistik_yenikonuslimit;
		$style = $options['style'];
		
        /*** Haric forumlar ***/
		$nodeIds = \XF::options()->xenistatistik_yenikonuforum;
		...
		return $this->renderer('XenistatistikYenikonu', $viewParams);
	}
