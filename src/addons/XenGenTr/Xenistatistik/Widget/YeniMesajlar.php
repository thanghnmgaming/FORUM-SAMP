...
class YeniMesajlar extends AbstractWidget
{
   ...
   public function render()
	{
        ...
        $isAddonEnabledGlobally = \XF::options()->offsetGet('xenistatistik_yenimesajkapat');
        ...
        $limit = \XF::options()->xenistatistik_yenimesajlimit;
		$filter = $options['filter'];

        /*** Haric forumlar ***/
		$nodeIds = \XF::options()->xenistatistik_yenimesajforum;
		...
		return $this->renderer('XenistatistikYeniMesaj', $viewParams);
	}
