...
class Kullanicilar extends AbstractWidget
{
	...
	public function render()
	{
        ...
        $isAddonEnabledGlobally = \XF::options()->offsetGet('xenistatistik_kullanicikapat');
		...
		{
            /*** gosterim limiti ***/
			if ($count == \XF::options()->xenistatistik_uyegosterim)
			{
		...
		return $this->renderer('Xenistatistikuye', $viewParams);
	}
