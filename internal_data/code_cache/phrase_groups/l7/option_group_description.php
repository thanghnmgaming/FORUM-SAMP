<?php
return array (
  'option_group_description.XGT_Kullanici_Banner' => '[XenGenTr] Kullanici banner sistemi görsel değişimler.',
  ...
  'option_group_description.border' => 'Options here control the Border add-on.',
...
You may set a user into \'discouraged\' mode by editing their user profile, or discourage an IP address or IP address range.',
  ...
  'option_group_description.mploading' => '[MPL] - Loading ile başlangıç sayfanı düzenle',
...
Có thể lọc nguồn cấp dữ liệu xuống chỉ cho những người dùng bạn theo dõi, hoặc một người dùng duy nhất.',
  ...
  'option_group_description.thusernamecolor' => 'Options for the [TH] User Name Color add-on.',
  ...
  'option_group_description.xgtForumistatistik_Secenekleri' => '[XenGenTr] Forum istatistik sistemi seçenekleridir.',
  'option_group_description.xmStyleProperty' => 'Các tùy chọn tính năng phong cách nâng cao và có thể tùy chỉnh.',
);