			...
			<div class="block-body block-body--collapsible is-active"
				...
				if ($__templater->func('count', array($__vars['permissionsGrouped'][$__vars['interfaceGroupId']], ), false) > 2) {
					...
					' . $__templater->formRow('
						...
						' . $__templater->button('Jump to' . $__vars['xf']['language']['ellipsis'], array(
						'class' => 'button--link menuTrigger',
						'data-xf-click' => 'menu',
						'aria-expanded' => 'false',
						'aria-haspopup' => 'true',
						...
						' . $__templater->callMacro('tckJumpToPermissions_permission_macros', 'jump_to_menu_global', array(
						'interfaceGroups' => $__vars['interfaceGroups'],
					), $__vars) . '
					', array(
			...
			<div class="block-body block-body--collapsible is-active"
				...
				if ($__templater->func('count', array($__vars['permissionsGrouped'][$__vars['interfaceGroupId']], ), false) > 2) {
					...
					' . $__templater->formRow('
						...
						' . $__templater->callMacro('tckJumpToPermissions_permission_macros', 'jump_to_menu_content', array(
						'interfaceGroups' => $__vars['interfaceGroups'],
						'interfaceGroupId' => $__vars['interfaceGroupId'],
						'permissionsGrouped' => $__vars['permissionsGrouped'],
					), $__vars) . '
					', array(
						'rowclass' => 'formRow--permissionQuickSet',
					)) . '
