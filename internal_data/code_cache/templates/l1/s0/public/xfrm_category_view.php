<?php
// FROM HASH: 6320b30962eaaa14d0c38c878700a8ae
...
' . $__templater->callMacro('metadata_macros', 'canonical_url', array(
		'canonicalUrl' => $__templater->func('link', array('canonical:resources/categories', $__vars['category'], array('page' => $__vars['page'], ), ), false),
	), $__vars) . '
...
' . $__templater->callMacro('xfrm_overview_macros', 'featured_carousel', array(
		...
		'viewAllLink' => $__templater->func('link', array('resources/categories/featured', $__vars['category'], ), false),
	), $__vars) . '
