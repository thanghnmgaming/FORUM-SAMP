		...
		if ($__templater->isTraversable($__vars['items'])) {
			...
			';
				...
				<div class="listBlock itemDetail itemDetailDate">
					<a class="paint" href="' . $__templater->func('link', array('resources', $__vars['resources'], ), true) . '" title="">' . 'Downloads' . ': ' . $__templater->filter($__vars['resource']['download_count'], array(array('number', array()),), true) . '</a>
				</div>
