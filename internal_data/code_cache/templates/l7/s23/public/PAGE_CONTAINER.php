<?php
// FROM HASH: bcf1999ae94e233378fcdf3442a4844e
	...
	if ($__vars['xf']['visitor']['user_id']) {
		...
		if (($__vars['xf']['visitor']['user_state'] == 'rejected') OR ($__vars['xf']['visitor']['user_state'] == 'disabled')) {
			...
			if ($__templater->method($__vars['xf']['visitor'], 'canStartConversation', array())) {
				$__finalCompiled .= '
								<span class="menu-footer-opposite">
									<a href="' . $__templater->func('link', array('conversations/add', ), true) . '">' . 'Bắt đầu trò chuyện mới' . '</a>
								</span>
							';
			}
			$__finalCompiled .= '
			...
			if (($__templater->func('property', array('xtr_message_block_enable', ), false) == '1') AND ($__templater->func('property', array('xtr_live_background_picker', ), false) == '1')) {
				$__finalCompiled .= '	
					<a href="#" class="p-navgroup-link bgPicker" data-xf-init="tooltip" title="' . 'Mở Trình chọn nền' . '"><i class="far fa-pen"></i></a>
				';
			}
			$__finalCompiled .= '
			';
...
<footer class="p-footer" id="footer">
	...
	if ($__vars['xf']['homePageUrl']) {
		$__finalCompiled .= '
						<li><a class="footer-home" href="' . $__templater->escape($__vars['xf']['homePageUrl']) . '">' . 'Trang chủ' . '</a></li>
					';
	}
	$__finalCompiled .= '
