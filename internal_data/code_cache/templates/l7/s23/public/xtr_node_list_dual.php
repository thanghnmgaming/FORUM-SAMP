...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '	
				<a href="' . $__templater->func('link', array('forums/post-thread', $__vars['node'], ), true) . '" class="menu-linkRow"><i class="fal fa-plus"></i> ' . 'Đăng chủ đề mới' . $__vars['xf']['language']['ellipsis'] . '</a>
			';
	}
	$__finalCompiled .= '
			<a href="' . $__templater->func('link', array('threads/latest', $__vars['extras']['LastThread'], ), true) . '" class="menu-linkRow"><i class="fad fa-comments-alt"></i> ' . 'Hoạt động cuối' . '</a>
		</div>
	</div>
	</div>
</div>
