<?php
// FROM HASH: 4b18bcae9bf186546d2a6f931e172fcf
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	$__finalCompiled = '';
	$__finalCompiled .= $__templater->callMacro('xgt_forumistatik_miniheader_macros', 'encokgoruntulenen', array(
		'encokgoruntulenen' => '!',
	), $__vars) . '
';
			...
			<li class="xgtIstatistikVerileri">
				...
				if ($__templater->method($__vars['thread'], 'getUserPostCount', array())) {
					$__finalCompiled .= '
						...
						'href' => '',
						'class' => 'avatar--separated Avatar-XS',
						'tabindex' => '0',
