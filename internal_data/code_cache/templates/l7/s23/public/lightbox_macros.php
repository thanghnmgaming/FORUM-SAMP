<?php
// FROM HASH: 8509790d126d95268ef16fdabe79aac5
...
'single_image' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
		<img src="' . $__templater->escape($__vars['src']) . '" data-url="' . $__templater->escape($__vars['dataUrl']) . '" class="bbImage" data-zoom-target="1" ' . ($__vars['alt'] ? (('alt="' . $__templater->filter($__vars['alt'], array(array('for_attr', array()),), true)) . '"') : '') . ' style="' . $__templater->escape($__vars['styleAttr']) . '" />
	</div>
';
	return $__finalCompiled;
