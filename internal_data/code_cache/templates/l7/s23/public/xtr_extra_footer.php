...
'whatsNewLinks' => function($__templater, array $__arguments, array $__vars)
{
	...
	<div class="block-container">
		<div class="block">
			<h3 class="block-minorHeader"><i class="' . $__templater->func('property', array('xtr_extra_footer_column_icon' . $__vars['block'], ), true) . '"></i><i class="fas fa-bolt"></i> ' . 'Có gì mới?' . '</h3>
			<div class="block-body block-row">
				' . '
				<div class="blockLink"><i class="fas fa-caret-right"></i> <a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'new_thread') ? $__templater->escape($__vars['selectedClass']) : '') . '" href="' . $__templater->func('link', array('whats-new/posts', ), true) . '" rel="nofollow">' . 'Bài viết mới' . '</a></div>
				' . '
				';
	if ($__templater->method($__vars['xf']['visitor'], 'canViewProfilePosts', array())) {
		$__finalCompiled .= '
					<div class="blockLink"><i class="fas fa-caret-right"></i> <a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'new_profile_post') ? $__templater->escape($__vars['selectedClass']) : '') . '" href="' . $__templater->func('link', array('whats-new/profile-posts', ), true) . '" rel="nofollow">' . 'Bài mới trên hồ sơ' . '</a></div>
				';
	}
	$__finalCompiled .= '
				' . '
	...
	if ($__vars['xf']['options']['enableNewsFeed']) {
		...
		if ($__vars['xf']['visitor']['user_id']) {
			$__finalCompiled .= '
						<div class="blockLink"><i class="fas fa-caret-right"></i> <a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'news_feed') ? $__templater->escape($__vars['selectedClass']) : '') . '" href="' . $__templater->func('link', array('whats-new/news-feed', ), true) . '" rel="nofollow">' . 'Luồng tin của bạn' . '</a></div>
					';
		}
		$__finalCompiled .= '

					<div class="blockLink"><i class="fas fa-caret-right"></i> <a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'latest_activity') ? $__templater->escape($__vars['selectedClass']) : '') . '" href="' . $__templater->func('link', array('whats-new/latest-activity', ), true) . '" rel="nofollow">' . 'Hoạt động mới nhất' . '</a></div>
				';
	}
	$__finalCompiled .= '
			</div>		
	...
	if ($__templater->func('property', array('xtr_enable_extra_footer_column2', ), false)) {
		...
		if ($__vars['blockId'] == 'custom') {
			...
			if ($__vars['xf']['options']['homePageUrl']) {
				$__finalCompiled .= '
								<div class="blockLink"><a class="' . $__templater->escape($__vars['baseClass']) . '" href="' . $__templater->escape($__vars['xf']['options']['homePageUrl']) . '">' . 'Trang chủ' . '</a></div>
							';
			}
			$__finalCompiled .= '
							<div class="blockLink"><a class="' . $__templater->escape($__vars['baseClass']) . '" href="' . $__templater->func('link', array('forums', ), true) . '">' . 'Diễn đàn' . '</a></div>
							<div class="blockLink"><a class="' . $__templater->escape($__vars['baseClass']) . '" href="' . $__templater->func('link', array('whats-new/posts', ), true) . '">' . 'Bài viết mới' . '</a></div>
						</div>
					';
		} else {
			$__finalCompiled .= '
