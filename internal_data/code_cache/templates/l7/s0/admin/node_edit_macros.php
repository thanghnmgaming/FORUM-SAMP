...
'position' => function($__templater, array $__arguments, array $__vars)
{
	...
	' . $__templater->formRadioRow(array(
		'name' => 'node[node_icon_type]',
		'value' => $__vars['node']['node_icon_type'],
	), array(array(
		'value' => 'default',
		'label' => 'Default node icon',
		'_type' => 'option',
	),
	array(
		'value' => 'fa',
		'label' => 'Fontawesome based node icon',
		'_type' => 'option',
	),
	array(
		'value' => 'img',
		'label' => 'Image or Svg as node icon',
		'_type' => 'option',
	),
	array(
		'value' => 'custom',
		...
		'label' => 'Node Icon Type',
		'hint' => 'Tùy chọn (không bắt buộc)',
	)) . '

	' . $__templater->formTextBoxRow(array(
		'name' => 'node[node_icon]',
		'value' => $__vars['node']['node_icon'],
		'dir' => 'ltr',
	), array(
		'label' => 'Node Icon',
		'hint' => 'Tùy chọn (không bắt buộc)',
		'explain' => '
			<div>Example for different node icon types:</div>
			<table>
				<tr><td>Fontawesome:</td><td>fa-address-card</td></tr>
				<tr><td>Image or Svg:</td><td>/style/xf/icon.svg</td></tr>
				<tr><td>Custom:</td><td>&lt;i class="icon-font icon"/&gt;</td></tr>
			</table>
		',
	)) . '

	' . $__templater->formTextBoxRow(array(
		'name' => 'node[node_icon_unread]',
		'value' => $__vars['node']['node_icon_unread'],
		'dir' => 'ltr',
	), array(
		'label' => 'Unread Node Icon',
		'hint' => 'Tùy chọn (không bắt buộc)',
		'explain' => 'Replace icon for node with unread messages',
	)) . '
';
	return $__finalCompiled;
},
