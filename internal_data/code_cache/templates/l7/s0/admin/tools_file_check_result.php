...
';
	...
	<div class="blockMessage blockMessage--success blockMessage--iconic">
		' . 'Tất cả ' . $__templater->filter($__vars['fileCheck']['total_checked'], array(array('number', array()),), true) . ' tập tin đã được kiểm tra đều chính xác.' . ' ' . $__templater->func('smilie', array(':)', ), true) . '
	</div>
';
	} else {
		$__finalCompiled .= '
