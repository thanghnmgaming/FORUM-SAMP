<?php
// FROM HASH: d64b33ddb37b42ef0c1f4ebf73654cd1
...
<footer class="p-footer">
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeLanguage', array())) {
		$__finalCompiled .= '
				<a href="' . $__templater->func('link', array('languages/admin', ), true) . '" data-xf-click="overlay" data-xf-init="tooltip" title="' . $__templater->filter('Chọn Ngôn ngữ', array(array('for_attr', array()),), true) . '">
