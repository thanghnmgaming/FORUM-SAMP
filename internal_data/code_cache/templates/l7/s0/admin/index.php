...
';
	...
	<div class="blockMessage blockMessage--important blockMessage--iconic">
		<a href="' . $__templater->func('link', array('templates/outdated', ), true) . '"> ' . 'Có những mẫu có thể đã lỗi thời. Nhấn vào đây để xem lại chúng.' . '</a>
	</div>
';
	}
	$__finalCompiled .= '
...
';
	if ($__templater->method($__vars['xf']['visitor'], 'hasAdminPermission', array('addOn', )) AND $__vars['hasProcessingAddOn']) {
		$__finalCompiled .= '
	<div class="blockMessage blockMessage--error blockMessage--iconic">
		' . 'Một hoặc nhiều tiện ích bổ sung hiện đang chờ xử lý và có thể ở trạng thái không nhất quán. Do đó, một số lỗi có thể bị chặn và hành vi không mong muốn có thể xảy ra. Nếu điều này không thay đổi trong thời gian ngắn, vui lòng liên hệ với tác giả của tiện ích bổ sung để được hướng dẫn.' . '<br />
		<br />
...
';
	...
	<div class="blockMessage blockMessage--error blockMessage--iconic">
		<a href="' . $__templater->func('link', array('tools/file-check/results', $__vars['firstFileCheck'], ), true) . '">
			' . 'Thiếu ' . $__templater->filter($__vars['firstFileCheck']['total_missing'] + $__vars['firstFileCheck']['total_inconsistent'], array(array('number', array()),), true) . ' tệp hoặc tệp có nội dung không mong muốn. Bạn nên xem lại những điều này.' . '
		</a>
	</div>
';
	}
