...
' . $__templater->formRadioRow(array(
	...
	array(
		...
		'label' => 'Visibility',
		'explain' => 'Use these settings to control visibility based on display size. These settings are linked to the <a href="' . $__templater->func('link', array('styles/style-properties/group', array('style_id' => $__vars['xf']['options']['defaultStyleId'], ), array('group' => 'page', ), ), true) . '">Responsive Design</a> style properties and may vary depending on the selected style.',
	)) . '
