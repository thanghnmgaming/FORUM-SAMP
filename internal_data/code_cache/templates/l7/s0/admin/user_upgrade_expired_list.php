...
';
	...
	<div class="block">
		...
		$__finalCompiled .= $__templater->dataList('
			...
			'_type' => 'cell',
			'html' => '<a href="' . $__templater->func('link', array('user-upgrades/expired', $__vars['userUpgrade'], array('order' => 'username', 'direction' => '', ) + $__vars['linkParams'], ), true) . '">' . 'Thành viên' . '</a>',
		),
		array(
			'_type' => 'cell',
			'html' => 'Upgrade title',
		...
		array(
			'_type' => 'cell',
			'html' => '<a href="' . $__templater->func('link', array('user-upgrades/expired', $__vars['userUpgrade'], array('order' => 'start_date', 'direction' => 'desc', ) + $__vars['linkParams'], ), true) . '">' . 'Ngày gửi' . '</a>',
		),
		array(
			'_type' => 'cell',
