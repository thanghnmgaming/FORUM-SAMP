...
'tabs' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->method($__vars['resource'], 'isVersioned', array())) {
		$__compilerTemp1 .= '
							<a class="tabs-tab ' . (($__vars['selected'] == 'history') ? 'is-active' : '') . '" href="' . $__templater->func('link', array('resources/history', $__vars['resource'], ), true) . '">' . 'Lịch sử' . '</a>
						';
	}
	$__compilerTemp1 .= '
						';
		...
		<div class="tabs tabs--standalone">
			<div class="hScroller" data-xf-init="h-scroller">
				<span class="hScroller-scroll">
					<a class="tabs-tab ' . (($__vars['selected'] == 'overview') ? 'is-active' : '') . '" href="' . $__templater->func('link', array('resources', $__vars['resource'], ), true) . '">' . 'Tổng quan' . '</a>
					' . $__compilerTemp1 . '
				</span>
			</div>
		</div>
