...
';
	...
	if ($__vars['xf']['options']['enableNewsFeed']) {
		...
		<a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'latest_activity') ? $__templater->escape($__vars['selectedClass']) : '') . '" href="' . $__templater->func('link', array('whats-new/latest-activity', ), true) . '" rel="nofollow">' . 'Hoạt động mới nhất' . '</a>
	';
	}
	$__finalCompiled .= '
	' . '
