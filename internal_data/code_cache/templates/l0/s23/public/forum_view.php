...
';
		...
		$__compilerTemp5['prefixType'] = 'thread';
		$__compilerTemp5['baseLinkPath'] = 'forums';
		$__compilerTemp5['container'] = $__vars['forum'];
		$__compilerTemp4 .= $__templater->includeTemplate('sv_multiprefix_filter', $__compilerTemp5) . '
