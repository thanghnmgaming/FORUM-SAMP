<?php
// FROM HASH: fd2d558d267c15bacd0abaeec30becd0
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	$__finalCompiled = '';
	$__finalCompiled .= '@_message-actionColumnWidth: 40px;
@_messageSimple-userColumnWidth: @avatar-s;
@_avatarPadding: 10px;
...
.message
{
	...
	&:not(.message--deleted)
	{
		.message-avatar .avatar.avatar--m
		{
			.m-avatarSize(120px);
...
.message-cell
{
	display: block;
	vertical-align: top;
	padding: @xf-messagePadding*2 @xf-messagePadding;
	...
	&.message-cell--user
	{
		.m-fixedWidthFlex((@xf-messageUserBlockWidth) + 2 * (@xf-messagePadding) + 2 * (@_avatarPadding));

		.message--simple &
		{
			.m-fixedWidthFlex(@_messageSimple-userColumnWidth + 2 * @xf-messagePadding + 2 * @_avatarPadding);
		}
	}
...
{
	margin-top: @xf-messagePadding;
	padding: @xf-messagePaddingSmall @xf-messagePadding*1.5;
}
